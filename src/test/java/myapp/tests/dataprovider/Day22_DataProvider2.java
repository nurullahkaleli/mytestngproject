...
When there are changes in test scenarios, updating the data set can be sufficient.
It is easy to update the data set and rerun the tests without modifying the test code, ensuring data maintainability.
    ...
    //NO NEED TO USE dataProviderClass = DataProviderUtils.class WHEN IN SAME CLASS
