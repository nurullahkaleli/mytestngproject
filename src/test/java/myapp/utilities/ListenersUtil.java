...
public class ListenersUtil implements ITestListener, IRetryAnalyzer, IAnnotationTransformer {
    ...
    We will also use Listeners for adding special functionality under special cases,
    such as take the screenshot for only failed test cases, or rerun the failed test case more than once automatically
